...
INSTALLED_APPS = [
    ...
    'conduit.apps.magazines',
    'conduit.apps.reviews',
]
...
DATABASES = {
    ...
    # PostgreSQL config (commented out for testing)
    # 'postgresql': {
    #     'ENGINE': 'django.db.backends.postgresql',
    #     'NAME': os.environ.get('DB_NAME', 'conduit'),
    #     'USER': os.environ.get('DB_USER', 'conduit_user'),
...
ACCOUNT_ADAPTER = 'conduit.apps.authentication.adapters.CustomAccountAdapter'
SOCIALACCOUNT_ADAPTER = 'conduit.apps.authentication.adapters.CustomSocialAccountAdapter'
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        'APP': {
            ...
            'key': os.environ.get('GOOGLE_OAUTH_CLIENT_ID', ''),
        }
    }
}
